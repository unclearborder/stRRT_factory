function [x, nearest, plotobj_scale_newpoint, theta, omega, v] = sample_x_P_randomly_noCylinder(node,In_list_ID, r_attempt, path, min_path_leng)
...
while true
    ...
    while  obstacle_issue == 1
        ...
        [x, obstacle_issue, nearest, plotobj_scale_newpoint] = sample_polyshape_check_noCylinder(node,In_list_ID,r_attempt,path, min_path_leng);
